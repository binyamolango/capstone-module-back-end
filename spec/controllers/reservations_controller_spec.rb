...
RSpec.describe Api::V1::ReservationsController, type: :controller do
  describe 'GET #index' do
    it 'returns a list of all reservations' do
      ...
      reservation1 = Reservation.create(user: user, doctor: doctor1, date_of_reservation: '12/4/2024')
      reservation2 = Reservation.create(user: user, doctor: doctor2, date_of_reservation: '12/4/2024')
      get :index
  ...
  describe 'GET #show' do
    it 'returns the details of a specific Reservation' do
      ...
      reservation = Reservation.create(user: user, doctor: doctor, date_of_reservation: '12/4/2024')
