...
RSpec.describe Api::V1::DoctorsController, type: :controller do
  describe 'GET #index' do
    it 'returns a list of all doctors' do
      Doctor.create(name: 'Dr. Smith', image_url: 'some_image.jpg', doctor_type: 'Cardiology',
                    address: '123 Main St')
      Doctor.create(name: 'Dr. Smith2', image_url: 'some_image.jpg', doctor_type: 'Cardiology',
                    address: '123 Main St')
      Doctor.create(name: 'Dr. Smith3', image_url: 'some_image.jpg', doctor_type: 'Cardiology',
                    address: '123 Main St')
      get :index
